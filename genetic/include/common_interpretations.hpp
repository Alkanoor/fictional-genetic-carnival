...
class Common_Interpretations
{
    public:
        ...
        static void add_interpretation(const std::string& name, const std::function<T(const std::bitset<N>&, int, int)>& func);
...
template <>
const std::function<int(const std::bitset<N>&, int, int)>& Common_Interpretations<N>::get_interpretation(const std::string& name)
{return integer_interpretations[name];}

template <>
const std::function<float(const std::bitset<N>&, int, int)>& Common_Interpretations<N>::get_interpretation(const std::string& name)
